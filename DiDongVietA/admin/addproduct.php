                ...
                <center>
                    <table>
                        <tr>
                            ...
                            <td><input type="text" name="title" placeholder="Enter name" style="width:560px" required></br></td>
                        </tr>
                        <tr>
                            <td><b>Cost</b></td>
                            <td><input type="text" name="cost" placeholder="Enter cost" style="width:560px" required></br></td>
                        </tr>
                        <tr>
                            <td><b>Quantity</b></td>
                            <td><input type="number" min="1" max="100" name="quantity" placeholder="Enter quantity" style="width:560px" required></td>
                        </tr>
                        <tr>
                            <td><b>Category</b></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><textarea name="description" id="description" cols="75" rows="10"></textarea></td>
                        </tr>
                    </table>
                </center>
