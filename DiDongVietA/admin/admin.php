            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    ...
                    <div class="navbar-search-block">
                        <form class="form-inline" method="post" action="../action/search.php">
                            <div class="input-group input-group-sm">
                                <input class="form-control form-control-navbar" type="search" name="product_name" placeholder="Search" aria-label="Search">
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th style="border-color:firebrick" scope="col">Description</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td style="border-color:firebrick">{$pro['description']}</td>
                    <td style="border-color:firebrick">
                    <form method="post" action="../action/delete.php" style="display: inline-block">
                        <input type="hidden" name="id" value="{$pro['pid']}"/>
                        <button type="submit">Delete</button>
                    </form>
                    <form method="post" action="editproduct.php" style="display: inline-block">
                        <input type="hidden" name="id" value="{$pro['pid']}"/>
                        <button type="submit" style="margin-top: 5px;">Edit</button>
                    </form>
                </td>
                </tr>
            </tbody>
